...
<html lang="es">
    ...
    <body>
        ...
        <article class="segundot">
            <h2>Despliege de Aplicaciones Web</h2>
        </article>
        <main class="container">
            
        </main>
        <footer class="piepagina">
            <a href="../index.php"><img src="../proyectoDEAW/webroot/css/img/atras.png" class="imageatras" alt="IconoAtras" /></a>
            <a href="https://github.com/AlbertoFRSauces/proyectoDEAW" target="_blank"><img href="https://github.com/AlbertoFRSauces/proyectoDEAW" target="_blank" src="../proyectoDEAW/webroot/css/img/github.png" class="imagegithub" alt="IconoGitHub" /></a>
